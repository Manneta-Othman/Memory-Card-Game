...
const cardImgs = [
  ...
  {src: 'src/assets/css.svg', matched: false},
  {src: 'src/assets/javascript.svg', matched: false},
  {src: 'src/assets/react.svg', matched: false},
  {src: 'src/assets/sass.svg', matched: false},
  {src: 'src/assets/bootstrap.svg', matched: false},
  {src: 'src/assets/typescript.svg', matched: false},
  {src: 'src/assets/redux.svg', matched: false}
]
